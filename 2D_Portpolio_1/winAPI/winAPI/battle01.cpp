...
HRESULT battle01::init(void)
{
	...
	_movingMap1 = IMAGEMANAGER->addImage("_movingMap1", "movingMap1.bmp", 1600, 600, true, RGB(255, 0, 255));
	_myCattle = IMAGEMANAGER->addImage("myCattle", "playerBase.bmp", 160, 320, true, RGB(255, 0, 255));
	_enemyCattle = IMAGEMANAGER->addImage("enemyCattle", "enemyBase1.bmp", 160, 320, true, RGB(255, 0, 255));
...
void battle01::render(void)
{
	if (_loading)
	{
		_movingMap1->render(getMemDC(), 0, 0, 800 - _loopX, 0, 800, 600);
		...
		_enemyCattle->render(getMemDC(), -780 + _loopX, 85);
...
void battle01::playerSelect(void)
{
	for (int i = 0; i < 5; i++)
	{
...
void battle01::enemySelect(void)
{
