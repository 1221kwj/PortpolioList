...
HRESULT battle02::init(void)
{
	...
	_movingMap2 = IMAGEMANAGER->addImage("_movingMap2", "movingMap2.bmp", 1600, 600, true, RGB(255, 0, 255));
	_myCattle = IMAGEMANAGER->addImage("myCattle", "playerBase.bmp", 160, 320, true, RGB(255, 0, 255));
	_enemyCattle2 = IMAGEMANAGER->addImage("enemyCattle2", "enemyBase2.bmp", 160, 320, true, RGB(255, 0, 255));
...
void battle02::render(void)
{
	if (_loading)
	{
		_movingMap2->render(getMemDC(), 0, 0, 800 - _loopX, 0, 800, 600);
		...
		_enemyCattle2->render(getMemDC(), -780 + _loopX, 85);
...
void battle02::playerSelect(void)
{
	for (int i = 0; i < 5; i++)
	{
...
void battle02::enemySelect(void)
{
